...
def estimate_resource_identities(managed_resources: int, framework_only: bool, 
                                  framework_sdkv2: bool) -> int:
    """
    Estimate resources that support Resource Identity.
    """
    if framework_only:
...
def analyze_provider(provider: dict, check_github: bool = False) -> dict:
    ...
    # Calculate resource identities
    resource_identities = estimate_resource_identities(
        managed_resources, framework_only, framework_sdkv2
    )
